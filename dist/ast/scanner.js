...
export class CodebaseScanner {
    rootDir;
    ignoreDirs = new Set(['node_modules', '.git', 'dist', 'build', '.next', 'out', 'target', '.gemini']);
    ...
    resolveImportPath(currentFile, importStr) {
